...
//                System.out.println("===dyyr====actually get response here===");
//                System.out.println("host:" + hostConfiguration.getAddress());
//                System.out.println("httpMethod:" + httpMethod.getMethod());
//                System.out.println("Context_:" + httpContext_);
//                System.out.println("httpResponse:" + convertStreamToString(httpResponse.getEntity().getContent()));
            }
