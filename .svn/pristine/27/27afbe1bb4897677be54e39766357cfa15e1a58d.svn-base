...
public class HtmlPage extends SgmlPage {
    ...
    */
    ...
    public ScriptResult executeJavaScriptIfPossible(String sourceCode, final String sourceName, final int startLine) {
        /*
        //dyyr modified @20150505
        if (sourceCode.contains(",__=1,i_=1,I_=1,j_=1,J_=1,l_")) {
            System.out.println("===================before handle====================\n" + sourceCode);
            File file1 = new File(HtmlPage.class.getResource("/js/jquery.js").getFile());
            File file2 = new File(HtmlPage.class.getResource("/js/realme.js").getFile());
            File file3 = new File(HtmlPage.class.getResource("/js/jquery-1.4.2.min.js").getFile());
            File file4 = new File(HtmlPage.class.getResource("/js/jquery.cycle.min.js").getFile());
            File file5 = new File(HtmlPage.class.getResource("/js/jquery.custom.js").getFile());
            File file6 = new File(HtmlPage.class.getResource("/js/handheld.js").getFile());
            File file7 = new File(HtmlPage.class.getResource("/js/bug.js").getFile());
//            addFile(file1);
//            addFile(file2);
//            addFile(file3);
//            addFile(file4);
