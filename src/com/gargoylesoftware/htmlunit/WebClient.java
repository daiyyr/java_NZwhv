...
import static eru.Worm.file2string;
...
public class WebClient implements Serializable {
    ...
    public <P extends Page> P getPage(final WebWindow webWindow, final WebRequest webRequest)
        ...
        if ("javascript".equals(protocol)) {
            ...
            //modified by dyyr @20150507 2:52
//            System.out.printf("=============this is the final response=============");
//            System.out.printf("======url:"+ webRequest.getUrl() +"======");
//            System.out.printf(webResponse.getContentAsString());
//            System.out.printf("=============this is end of the final response=============");
            ...
            webResponse = loadWebResponse(webRequest);//dyyr3
//            if (webResponse.getContentAsString().contains("Please enable JavaScript to view the page content.")){
//                System.out.println(webRequest.getUrl().toString());
//                if(webRequest.getUrl().toString().equals("https://www.immigration.govt.nz/secure/Login+Working+Holiday.htm")) {
//                    File loginPage = new File(Worm.class.getResource("jsp/loginPage.jsp").getFile());
//                    webResponse.setContent(file2string(loginPage));
//                }
//                if(webRequest.getUrl().toString().contains("WorkingHoliday/Wizard/Personal1")) {
//                    File loginPage = new File(Worm.class.getResource("jsp/personal1.jsp").getFile());
//                    webResponse.setContent(file2string(loginPage));
//                }
//            }
        }
    ...
    public Page loadWebResponseInto(final WebResponse webResponse, final WebWindow webWindow)
        ...
        //modified by dyyr @2015.5.7
//        System.out.println("============this is webResponse================");
//        System.out.println(webResponse.getContentAsString());
//        System.out.println("============ webResponse end ================");
...
//dyyr created @20150510
    public List<NameValuePair> mocRresponseHeaders_(String ... params){
        ...
        for (String str : params) {
            ...
            if(num%2==1){
                ...
                str2 = str;
                headers.add(new NameValuePair(str1,str2));
            }
        }
        return headers;
    }

    public List<NameValuePair> mocResponseHeaders(String str){
        List<NameValuePair> headers = new ArrayList<NameValuePair>();
        String[] strs = str.split(", (?=[^,]*=)");
        for (String s : strs) {
            String[] t = s.split("=",2);
            headers.add(new NameValuePair(t[0],t[1]));
        }
        return headers;
    }

    public WebResponse mockResponse(WebRequest webRequest, String file, String headers){
        List<NameValuePair> headers_ =
                mocResponseHeaders(headers);
        WebResponseData mockData = new WebResponseData(200, "OK", headers_);
        mockData.setContent(file2string(file));
        WebResponse mock = new WebResponse( mockData, webRequest, 1024);
        return mock;
    }
    ...
    private WebResponse loadWebResponseFromWebConnection(final WebRequest webRequest,
        ...
        if(applicationId == null){
            if(url.toString().contains("ApplicationId")) {
                Pattern p1 = Pattern.compile("(?<=ApplicationId=)\\d*");
                Matcher m1 = p1.matcher(url.toString());
                if (m1.find()) {
                    applicationId = m1.group();
                }
                System.out.println("dyyr test first get ApplicationId: "+url.toString());
            }
        }else{
            if(url.toString().contains("1251115")) {
                System.out.println("dyyr test, url find 1251115! url= "+ url.toString());
                System.out.println("true applicationId: " + applicationId);
                url = UrlUtils.toUrlUnsafe(url.toString().replace("1251115", applicationId));
            }
        }
        if(url.toString().contains("SetFocus.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/SetFocus.js", "Content-Length=1410, Content-Type=application/x-javascript, Expires=30 Oct 1999 14:19:41 GMT, Last-Modified=Tue, 13 May 2014 03:54:54 GMT, Accept-Ranges=bytes, ETag=\"07b27195f6ecf1:53b3\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 07:33:28 GMT, Set-Cookie=TS0120d49b=; Path=/");
            return myResponse;
        }
        if(url.toString().contains("jquery.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/jquery.js", "Content-Length=94839, Content-Type=application/x-javascript, Last-Modified=Wed, 29 May 2013 22:41:00 GMT, Accept-Ranges=bytes, ETag=\"0267697bd5cce1:481b\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 05:49:35 GMT, Set-Cookie=TS0120d49b=0152807fb2098cd7bd947f78b70dc1d6d3a2c8a5b180640bf8c31821c48f379a2b4e06876a291786e61a90b5f3a908263c398f92f7402fe1566d75e76ed4ac1b71d8010deb; Path=/");
            return myResponse;
        }
        if(url.toString().contains("realme.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/realme.js", "Content-Length=3242,  Content-Type=application/x-javascript, Last-Modified=Wed, 29 May 2013 22:41:00 GMT, Accept-Ranges=bytes, ETag=\"0267697bd5cce1:481b\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 06:05:10 GMT, Set-Cookie=TS0120d49b=0152807fb284093ada10f43a1692af14e0bcfafc3cfcd64a495e0589361ee2fad1fce3392c111d8df18c39cc9d3b9b811d68c3f77629080ce4b8c368672eb4b099bc921f8f; Path=/");
            return myResponse;
        }
        if(url.toString().contains("cycle.min.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/jquery.cycle.min.js", "Content-Length=20160, Content-Type=application/x-javascript, Last-Modified=Tue, 08 Nov 2011 20:37:54 GMT, Accept-Ranges=bytes, ETag=\"0fd6d4a569ecc1:481b\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 06:14:37 GMT, Set-Cookie=TS0120d49b=0152807fb2cec0bd8012a8d32d21eac29881d50b3ad033ed3f1575683bfe08bd9f8b3d8ab9c1a139b48b06315c216933e8013f54161b8bffe9eb8e89e063ff1de40bd0cda5; Path=/");
            return myResponse;
        }
        if(url.toString().contains("jquery.min.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/jquery.min.js", "age=599096, alternate-protocol=80:quic,p=1, date=Wed, 06 May 2015 06:56:05 GMT, expires=Thu, 05 May 2016 06:56:05 GMT, server=GFE/2.0, status=304 Not Modified, version=HTTP/1.1");
            return myResponse;
        }
        if(url.toString().contains("custom.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/jquery.custom.js", "Content-Length=1129, Content-Type=application/x-javascript, Last-Modified=Tue, 16 Jul 2013 05:44:44 GMT, Accept-Ranges=bytes, ETag=\"f735493e781ce1:481b\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 06:15:46 GMT, Set-Cookie=TS0120d49b=0152807fb2cec0bd8012a8d32d21eac29881d50b3ad033ed3f1575683bfe08bd9f8b3d8ab9c1a139b48b06315c216933e8013f54161b8bffe9eb8e89e063ff1de40bd0cda5; Path=/");
            return myResponse;
        }
        if(url.toString().contains("handheld.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/handheld.js", "Content-Length=4549, Content-Type=application/x-javascript, Last-Modified=Tue, 08 Nov 2011 20:37:54 GMT, Accept-Ranges=bytes, ETag=\"0fd6d4a569ecc1:481b\", X-Powered-By=ASP.NET, Date=Sun, 10 May 2015 06:17:39 GMT, Set-Cookie=TS0120d49b=0152807fb2cec0bd8012a8d32d21eac29881d50b3ad033ed3f1575683bfe08bd9f8b3d8ab9c1a139b48b06315c216933e8013f54161b8bffe9eb8e89e063ff1de40bd0cda5; Path=/");
            return myResponse;
        }
        if(url.toString().contains("ga.js")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/ga.js", "Date=Sun, 10 May 2015 05:36:16 GMT, Expires=Sun, 10 May 2015 07:36:16 GMT, Last-Modified=Mon, 27 Apr 2015 18:49:35 GMT, X-Content-Type-Options=nosniff, Content-Type=text/javascript, Vary=Accept-Encoding, Server=Golfe2, Age=2539, Cache-Control=public, max-age=7200");
            return myResponse;
        }
        if(url.toString().contains("__utm.gif")){
            WebResponse myResponse;
            myResponse = mockResponse(webRequest, "js/__utm.gif", "Access-Control-Allow-Origin=*, Date=Sun, 10 May 2015 06:58:00 GMT, Pragma=no-cache, Expires=Fri, 01 Jan 1990 00:00:00 GMT, Cache-Control=no-cache, no-store, must-revalidate, Last-Modified=Sun, 17 May 1998 03:00:00 GMT, X-Content-Type-Options=nosniff, Content-Type=image/gif, Server=Golfe2, Content-Length=35");
            return myResponse;
        }
...
//        if(url.toString().contains("Application/Submit.aspx")) {
//            System.out.println("dyyr test, Submit method: "+webRequest.getHttpMethod());
//
//        }
        //dyyr2


//        System.out.println("dyyr test every responseContent:"+webResponse.getContentAsString());
        if (webResponse.getContentAsString().contains("Please enable JavaScript to view the page content.")){
            String urlS = url.toString();
            File myFile;
            System.out.println(" WebClient.loadWebResponseFromWebConnection() get 'Please enable JavaScript' page, request method: "+ webRequest.getHttpMethod().toString() +", response url: "+ urlS);
            if(urlS.equals("https://www.immigration.govt.nz/secure/Login+Working+Holiday.htm")) {
                webResponse.setContent(file2string("jsp/loginPage.jsp").replace("1251115",applicationId));
            }
            if(urlS.contains("Application/Create.aspx?CountryId=82")) {
                if(webRequest.getHttpMethod()== HttpMethod.GET) {
                    webResponse.setContent(file2string("jsp/country82.jsp"));
                }else{//should not mock while apply now post request
//                    myFile = new File(Worm.class.getResource("jsp/personal1.jsp").getFile());
//                    webResponse.setContent(file2string(myFile).replace("1251115","1360710"));
                }
            }
            if(urlS.contains("Application/Create.aspx?CountryId=46")) {
                if(webRequest.getHttpMethod()== HttpMethod.GET) {
                    webResponse.setContent(file2string("jsp/country46.jsp"));
                }else{
                    webResponse.setContent(file2string("jsp/personal1.jsp").replace("1251115","1360710"));
                }
            }
            if(urlS.contains("Application/Create.aspx?CountryId=104")) {
                if(webRequest.getHttpMethod()== HttpMethod.GET) {
                    webResponse.setContent(file2string("jsp/country104.jsp"));
                }else{
                    webResponse.setContent(file2string("jsp/personal1.jsp").replace("1251115","1360710"));
                }
            }
            if(urlS.contains("WorkingHoliday/Wizard/Personal1")) {
                webResponse.setContent(file2string("jsp/personal1.jsp").replace("1251115",applicationId));
//                System.out.println("test dyyr webResponse:"+ webResponse.getContentAsString());
//                System.out.println("test dyyr appID: "+applicationId);
            }
            if(urlS.contains("WorkingHoliday/Wizard/Personal2")) {
                webResponse.setContent(file2string("jsp/personal2.jsp").replace("1251115",applicationId));
//                System.out.println("test dyyr appID: "+applicationId);
            }
            if(urlS.contains("WorkingHoliday/Wizard/Medical1")) {
                webResponse.setContent(file2string("jsp/health.jsp").replace("1251115",applicationId));
            }
            if(urlS.contains("WorkingHoliday/Wizard/Character")) {
                webResponse.setContent(file2string("jsp/character.jsp").replace("1251115",applicationId));
            }
            if(urlS.contains("WorkingHoliday/Wizard/WorkingHolidaySpecific")) {
                if(urlS.contains("qs=")) {
                    webResponse.setContent(file2string("jsp/allFormsOK.jsp").replace("1251115", applicationId));
                }else {
                    webResponse.setContent(file2string("jsp/specific.jsp").replace("1251115", applicationId));
                }
            }
            if(urlS.contains("Application/Submit.aspx")) {
                if(webRequest.getHttpMethod()== HttpMethod.GET){
                    webResponse.setContent(file2string("jsp/checkPage.jsp").replace("1251115",applicationId));
                }else{
                    webResponse.setContent(file2string("jsp/choosePayWay.jsp").replace("1251115",applicationId));
                }
            }
            if(urlS.contains("Application/Pay.aspx")) {
                webResponse.setContent(file2string("jsp/pay1.jsp").replace("1251115",applicationId));
            }
            // may should not mock Pay2
            if(urlS.contains("PaymentGateway/OnLinePayment.aspx")) {
                webResponse.setContent(file2string("jsp/pay2.jsp").replace("1251115",applicationId));
            }

//            if(urlS.contains("WorkingHoliday/Wizard/Personal1")) {
//                myFile = new File(Worm.class.getResource("jsp/personal1.jsp").getFile());
//                webResponse.setContent(file2string(myFile));
//            }
        ...
        for (int i = queue.size() - 1; i >= 0; --i) {
            ...
            if (!updatedWindows.contains(window)) {
                ...
                if (downloadedResponse.urlWithOnlyHashChange_ != null) {
                    ...
                    //modified by dyyr @ 3:07
//                    System.out.println("dyyr in loadDownloadedResponses:");
//                    System.out.println(downloadedResponse.response_.getContentAsString());
